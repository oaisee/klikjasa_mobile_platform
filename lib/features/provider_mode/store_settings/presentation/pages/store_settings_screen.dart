...
class _StoreSettingsScreenState extends State<StoreSettingsScreen> {
  ...
  final Map<String, OperationalHourEntity> _operationalHours = {
  ...
  // Lokasi workshop dan radius layanan
  ...
  Future<void> _initializeBloc() async {
    ...
    // Muat pengaturan layanan dari database
    ...
    if (_storeSettingsBloc == null) {
      return Scaffold(
        ...
        appBar: AppBar(
          ...
          elevation: 0,
          title: const Text('Pengaturan Layanan', style: TextStyle(color: Colors.white)),
          leading: IconButton(
      ...
      child: BlocConsumer<StoreSettingsBloc, StoreSettingsState>(
            ...
            setState(() {
              ...
              if (state.settings.operationalHours.isNotEmpty) {
                state.settings.operationalHours.forEach((day, value) {
                  _operationalHours[day] = OperationalHourEntity(
                    isOpen: value.isOpen,
        ...
        builder: (context, state) {
          return Scaffold(
            backgroundColor: Colors.white,
            appBar: AppBar(
              title: const Text('Pengaturan Layanan'),
              elevation: 0,
              backgroundColor: AppColors.primary,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
                ...
                Switch(
                  ...
                  onChanged: (value) {
                    if (_currentUserId != null) {
                      ...
                      CustomSnackbar.show(
                        context: context,
                        message: 'Gagal memperbarui status layanan: ID pengguna tidak ditemukan',
                        type: SnackbarType.error,
                      );
                    }
                  },
            ...
            Text(
              _storeActive
                  ? 'Layanan Anda terlihat oleh pelanggan dan dapat menerima pesanan.'
                  : 'Layanan Anda tidak terlihat oleh pelanggan dan tidak dapat menerima pesanan.',
  ...
  Widget _buildOperationalHourItem(String day, OperationalHourEntity data) {
    return Padding(
      padding: const EdgeInsets.symmetric(vertical: 8),
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
          ...
          Switch(
            ...
            onChanged: (value) {
              if (_currentUserId != null) {
                ...
                setState(() {
                  _operationalHours[day] = _operationalHours[day]!.copyWith(isOpen: value);
                });
          ...
          Expanded(
            child: data.isOpen
                ? Row(
                    ...
                    children: [
                      Flexible(
                        child: _buildTimeButton(context, data.openTime, (time) {
                          if (_currentUserId != null) {
                            // Update jam buka di UI lokal
                            setState(() {
                              _operationalHours[day] = _operationalHours[day]!.copyWith(openTime: time);
                            });
                      ...
                      const SizedBox(width: 4),
                      Flexible(
                        child: _buildTimeButton(context, data.closeTime, (time) {
                          if (_currentUserId != null) {
                            // Update jam tutup di UI lokal
                            setState(() {
                              _operationalHours[day] = _operationalHours[day]!.copyWith(closeTime: time);
                            });
  ...
  void _updateOperationalHoursInDatabase(String day) {
    ...
    // Ambil data jam operasional dari entity yang sudah ada
    final operationalHour = _operationalHours[day]!;
  ...
  Widget _buildSaveButton() {
    return SizedBox(
      ...
      child: ElevatedButton(
        onPressed: () {
          if (_currentUserId != null) {
            // Kumpulkan semua pengaturan layanan
  ...
  void _showLocationEditDialog() {
    ...
    showDialog(
      ...
      builder: (dialogContext) => AlertDialog(
        title: const Text('Edit Alamat Workshop'),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            TextField(
              ...
              decoration: const InputDecoration(
                labelText: 'Alamat Workshop',
                hintText: 'Masukkan alamat lengkap workshop Anda',
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              ...
              if (_currentUserId != null) {
                // Update alamat workshop di database
