...
/// Layar pencarian layanan yang telah direfaktor untuk menggunakan Cubit secara konsisten
...
class _SearchScreenState extends State<SearchScreen> {
  ...
  Widget build(BuildContext context) {
    // Mendapatkan SearchCubit dari context
      ...
      appBar: AppBar(
        title: TextField(
          ...
          decoration: InputDecoration(
            ...
            suffixIcon: searchCubit.getSearchingStatus()
                ? IconButton(
          ...
          onChanged: (value) {
            // Menggunakan Cubit untuk mengelola state pencarian
            searchCubit.setCurrentQuery(value);
          },
        ),
        leading: IconButton(
              ...
              itemBuilder: (context, index) {
                ...
                return Padding(
                  ...
                  child: ServiceCardAdapter.fromServiceWithLocation(
                    ...
                    displayType: CardDisplayType.list, // Menggunakan tampilan list
                  ),
                );
              },
            );
