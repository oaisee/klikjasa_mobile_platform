...
import 'package:klik_jasa/features/user_mode/home/domain/entities/service_with_location.dart'; // Pastikan ini diimpor

/// Widget tab 'Terbaru' yang menampilkan layanan terbaru berdasarkan lokasi pengguna.
class TerbaruTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<ServiceLocationCubit>(
          ...
          supabase
              ...
              .then((profileData) {
                if (profileData != null) {
                  ...
                  // Jika tidak ada profil pengguna, gunakan default.
                  cubit.fetchServicesByLocation();
                }
              })
              .catchError((_) {
                // Jika terjadi kesalahan saat mengambil profil, gunakan default.
                cubit.fetchServicesByLocation();
              });
        } else {
          // Jika tidak ada ID pengguna, gunakan default.
          cubit.fetchServicesByLocation();
        }
      ...
      child: CustomScrollView(
        key: const PageStorageKey<String>('terbaru'),
        slivers: <Widget>[
          // BlocBuilder untuk mengelola state layanan terbaru.
          BlocBuilder<ServiceLocationCubit, ServiceLocationState>(
            builder: (context, state) {
              if (state is ServiceLocationLoading) {
                  ...
                  return SliverToBoxAdapter(
                    child: Column(
                      children: [
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                'Layanan Terbaru di ${state.userProvinsi ?? ""}',
                        ...
                        _buildServiceGrid(context, state.services,
                            'Tidak ada layanan terbaru tersedia di provinsi Anda'),
                      ],
                    ),
                  );
                }
                  ...
                  return SliverToBoxAdapter(
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              const SizedBox(width: 4),
                              Text(
                                'Layanan Terbaru di ${state.userKabupatenKota}',
                                style: Theme.of(context).textTheme.titleMedium
                                    ?.copyWith(
                                      fontWeight: FontWeight.bold,
                                      color: Colors.grey[700],
                        ...
                        _buildServiceGrid(context, state.services,
                            'Tidak ada layanan terbaru tersedia di lokasi Anda'),
                      ],
                    ),
                  );
                }
                ...
                return SliverToBoxAdapter(
                  child: _buildServiceGrid(context, state.services,
                      'Tidak ada layanan terbaru tersedia'),
                );
  ...
  /// Mengurutkan layanan berdasarkan prioritas promosi dan ID terbesar (terbaru), lalu menampilkannya dalam grid.
  Widget _buildServiceGrid(
      BuildContext context, List<ServiceWithLocation> services, String emptyMessage) {
    if (services.isEmpty) {
      return Padding(
        padding: const EdgeInsets.all(16.0),
        child: Center(
    ...
    // Urutkan berdasarkan prioritas: layanan promosi di atas, lalu berdasarkan ID terbesar (terbaru).
    final sortedServices = List<ServiceWithLocation>.from(services)
      ..sort((a, b) {
        ...
        // Jika status promosi sama, urutkan berdasarkan ID terbesar (terbaru).
        // Asumsikan id tidak null karena merupakan field yang diperlukan
